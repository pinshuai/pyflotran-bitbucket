...
def compare_calcitetranonly():
    ...
    return  filecmp.cmp('calcite_tran_only.in', dir + '/calcite_tran_only.gold')
...
class calcitetranonly_read(unittest.TestCase):
	...
	os.system('rm -f ' + './calcite_tran_only.in')
	os.system('rm -f ' + './calcite_tran_only.out')
	os.system('rm -f ' + './calcite_tran_only*.tec')
	os.system('rm -f ' + './calcite_tran_only*.regression')
