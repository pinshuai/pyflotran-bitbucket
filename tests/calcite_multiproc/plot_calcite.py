...
dat = pdata('')
dat.plot_data_from_tec(variable_list=['Calcite VF','Calcite Rate','pH'],tec_filenames=files,plot_filename='combined_calcite_vf.pdf',legend_list=legend_list,xlabel='x [m]',ylabel_list=['Calcite VF', 'Calcite Rate', 'pH'])
